...
<form action="<%=request.getContextPath() %>/teacher/editTeacher" method="post">
<div class="form-group">
    <label for="txt_tname">姓名:</label>
    <input type="text" class="form-control" value="${teacher.tname}" id="txt_tname" name="tname" placeholder="请输入教师姓名">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" value="${teacher.temail}" id="txt_temail" name="temail" placeholder="请输入邮箱">
  </div>
