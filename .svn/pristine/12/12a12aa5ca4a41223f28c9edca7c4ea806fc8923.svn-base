...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="txt_tname" name="ClassName" placeholder="请输入班级名称">
  </div>
  
  <div class="form-group">
    <label for="exampleInputPassword1">班级人数:</label>
    <input type="text" class="form-control" id="txt_temail" name="ClassCount" placeholder="请输入班级人数">
  </div>
